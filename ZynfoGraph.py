...
if uploaded_file is not None:
    ...
    with st.spinner("Loading data..."):
        df, load_message = load_data(uploaded_file)
        if df is not None:
            ...
            with st.spinner("Cleaning data..."):
                ...
                if clean_error: # This will now only be for warnings/partial success
                    st.warning("Data cleaning encountered issues: " + clean_error) # Changed to warning as it's not a fatal error anymore
                elif operations:
...
st.markdown(
    ...
    🚀 Built with ❤️ by <strong>Nandeesh</strong><br><br>
